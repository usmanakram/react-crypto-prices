...
export function header() {
  ...
  function navControl() {
    if (window.$(window).width() < 992) {
      ...
      window.$("#navbarSupportedContent .dropdown>a").on("click", function(e) {
        e.preventDefault();
        window
          .$(this)
...
export function highlights() {
  var updatingChartOne = window.$(".updating-chart-one").peity("line", {
    width: 60,
    height: 70,
  ...
  var updatingChartTwo = window.$(".updating-chart-two").peity("line", {
    width: 60,
    height: 70,
  ...
  var updatingChartThree = window.$(".updating-chart-three").peity("line", {
    width: 60,
    height: 70,
    fill: "rgba(220,0,0,.20)",
    stroke: "#dd1900"
  ...
  var updatingChartFour = window.$(".updating-chart-four").peity("line", {
    width: 60,
    height: 70,
    fill: "rgba(0,93,98,.30)",
    stroke: "#00c162"
...
export function depthChart() {
  window.Highcharts.chart("depthChartStyle", {
    chart: {
      type: "area",
      zoomType: "xy"
    },
    ...
    series: [
      {
        ...
        data: [
          ...
          // [0.153, 60.30799400000001],
          [0.1548, 60.30799400000001],
